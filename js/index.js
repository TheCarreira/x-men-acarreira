...
imagem, o nome e o texto grande do personagem que está selecionado
    ...
    OBJETIVO 2 - quando passar mouse em cima do personagem na listagem,, trocar a imagem, o nome e a descrição
...
//     passo 1 - pegar o elemento do personagem grande para adicionar as informações nele
        ...
        descricaoDoPersonagem(personagem);

   })
})
function descricaoDoPersonagem(personagem) {
    const descricaoPersonagem = document.getElementById('descricao-personagem');
    descricaoPersonagem.innerText = personagem.getAttribute('data-description');
}

function nomeDoPersonagem(personagem) {
